...
consvar_t cv_cam_savedist[2][2] = {
	{ // standard
		CVAR_INIT ("cam_dist", "256", CV_FLOAT|CV_SAVE|CV_CALL, NULL, CV_UpdateCamDist),
		CVAR_INIT ("cam2_dist", "256", CV_FLOAT|CV_SAVE|CV_CALL, NULL, CV_UpdateCam2Dist),
	},
	{ // simple
...
consvar_t cv_cam_saveheight[2][2] = {
	{ // standard
		CVAR_INIT ("cam_height", "50", CV_FLOAT|CV_SAVE|CV_CALL, NULL, CV_UpdateCamDist),
		CVAR_INIT ("cam2_height", "50", CV_FLOAT|CV_SAVE|CV_CALL, NULL, CV_UpdateCam2Dist),
	},
	{ // simple
		CVAR_INIT ("cam_simpleheight", "50", CV_FLOAT|CV_SAVE|CV_CALL, NULL, CV_UpdateCamDist),
		CVAR_INIT ("cam2_simpleheight", "50", CV_FLOAT|CV_SAVE|CV_CALL, NULL, CV_UpdateCam2Dist),
