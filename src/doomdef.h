...
//#endif
#if defined (_WIN32) || (defined (__unix__) && !defined (MSDOS)) || defined(__APPLE__) || defined (UNIXCOMMON) || defined (macintosh) || defined(__WUT__)
...
#if !defined(__WIIU__) || !defined(LOWMEM) //TODO: find the actual error
